    ...
    <section className="hero-section-full" id="home">
      <div className="container hero-grid-full" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <motion.div
          ...
          animate="visible"
        >
          <motion.h1 className="heading-xl" style={{ marginBottom: 20 }} variants={itemVariants}>
            Turn Home Repair into Solutions in Seconds, Not Hours
          </motion.h1>

          <motion.p className="text-lead" style={{ marginBottom: 32, maxWidth: 520 }} variants={itemVariants}>
          ...
          <motion.div className="hero-ctas-row" variants={itemVariants}>
          ...
          <motion.div className="hero-store-buttons" variants={itemVariants}>
